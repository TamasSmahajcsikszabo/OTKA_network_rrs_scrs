...
For the network analysis, the tuning parameter of *gamma* in the graphical LASSO algorithm has been set to 0.5 value in accordance with [@Bernstein2019] in order to achieve sparse graphs. The final networks were chosen by the lowest values of the *extended Bayesian Information Criterion* (EBIC).
